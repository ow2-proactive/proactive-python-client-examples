...
def HOST_MOUNT_PATH = null
if (variables.get("HOST_MOUNT_PATH") != null && !variables.get("HOST_MOUNT_PATH").isEmpty()) {
    HOST_MOUNT_PATH = variables.get("HOST_MOUNT_PATH")
} else if (variables.get("MOUNT_MOUNT_PATH") != null && !variables.get("MOUNT_MOUNT_PATH").isEmpty()) {
    HOST_MOUNT_PATH = variables.get("MOUNT_MOUNT_PATH") // backwards compatibility
}

def CONTAINER_MOUNT_PATH = null
if (variables.get("CONTAINER_MOUNT_PATH") != null && !variables.get("CONTAINER_MOUNT_PATH").isEmpty()) {
    CONTAINER_MOUNT_PATH = variables.get("CONTAINER_MOUNT_PATH")
} else if (variables.get("DOCKER_MOUNT_PATH") != null && !variables.get("DOCKER_MOUNT_PATH").isEmpty()) {
    CONTAINER_MOUNT_PATH = variables.get("DOCKER_MOUNT_PATH") // backwards compatibility
}

def TENSORBOARD_HOST_MOUNT_PATH = null
if (variables.get("TENSORBOARD_HOST_MOUNT_PATH") != null && !variables.get("TENSORBOARD_HOST_MOUNT_PATH").isEmpty()) {
    TENSORBOARD_HOST_MOUNT_PATH = variables.get("TENSORBOARD_HOST_MOUNT_PATH")
}

def TENSORBOARD_CONTAINER_MOUNT_PATH = null
if (variables.get("TENSORBOARD_CONTAINER_MOUNT_PATH") != null && !variables.get("TENSORBOARD_CONTAINER_MOUNT_PATH").isEmpty()) {
    TENSORBOARD_CONTAINER_MOUNT_PATH = variables.get("TENSORBOARD_CONTAINER_MOUNT_PATH")
}
