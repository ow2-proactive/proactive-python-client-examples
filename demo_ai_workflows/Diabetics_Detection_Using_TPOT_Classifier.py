...
The script leverages 'proactive' for smooth connection to the ProActive gateway, ensuring efficient job orchestration and execution. After the job completes, it guarantees a proper gateway disconnection and termination, preserving system and resource integrity.
...
job.setJobName("Diabetics_Detection_Using_TPOT_Classifier")
...
job.addTask(tpot_classifier_task)
